<template>
	<view class="container">
		...
		<view class="nav">
			<view class="nav-left">
				<image src="../static/img/dt_store_back.png" @click="onBack"></image>
			</view>
...
<script>
	export default {
		...
		onShow() {
			...
			this.leaves = uni.getStorageSync('todaySchoolInforms');
			//this.leaves.reverse();
		...
		methods: {
			...
			clearAll: function() {
				uni.showModal({
					...
					success: function(e) {
						if (e.confirm) {
							uni.setStorageSync("todaySchoolInforms", null);
							this.leaves = null;
							uni.reLaunch({
								url: 'index'
							})
			...
			clickContent: function(i) {
				...
				uni.setStorageSync("currInforms", this.leaves[i]);
